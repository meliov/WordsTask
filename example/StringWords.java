...
public class StringWords {
    ...
    static class DepthWord{
        ...
        static  Set<String> allWordsBetween2and9LettersSet = new HashSet<>();
        ...
        public int getDepth(){
         ...
         static DepthWord mapChildren(String wordValue, int index){
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<String> myWords = nineLetterWords.stream().map(word -> {
                    ...
                    for (int i = 0; i < word.length(); i++) {
                        childWord.add(DepthWord.mapChildren(word, i));
                    }
